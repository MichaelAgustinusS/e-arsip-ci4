...
<div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?= base_url('arsip')?>" class="small-box-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?= base_url('dep')?>" class="small-box-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
